...
def run(args):
    ...
    if 'yolov8' not in str(args.yolo_model):
        ...
        model = m(
            ...
            class_names = args.custom_classes
        )
...
def parse_opt():
    ...
    parser.add_argument('--checkpoint_path', type=Path,
                        help='if you want to load you fine tuned model then enter the path of your custom yolo model')
    parser.add_argument('--custom_classes', nargs='+', type=str, default='',
                        help='classes in the specific order that model detects EX: --class_names "class1" "class2"')
